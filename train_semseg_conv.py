import argparse
import os
from data_utils.ScannetDataLoader import ScannetDatasetWholeScene, ScannetDataset
import torch
import datetime
import logging
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pointconv_sem_seg', help='model name [default: pointnet_sem_seg]')
...
def main(args):
    ...
    TEST_DATASET = ScannetDataset(root, split='val')
