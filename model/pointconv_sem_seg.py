...
from utils.pointconv_util import PointConvDensitySetAbstraction,PointConvFeaturePropagation
...
class get_model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fp4 = PointConvFeaturePropagation(npoint=512, nsample=32, in_channel=515, out_put=768, mlp=[512, 256], bandwidth=0.8, group_all=False)
        self.fp3 = PointConvFeaturePropagation(npoint=256, nsample=32, in_channel=259, out_put=384, mlp=[256, 256], bandwidth=0.4, group_all=False)
        self.fp2 = PointConvFeaturePropagation(npoint=256, nsample=32, in_channel=259, out_put=320, mlp=[256, 128], bandwidth=0.2, group_all=False)
        self.fp1 = PointConvFeaturePropagation(npoint=128, nsample=32, in_channel=131, out_put=128, mlp=[128, 128, 128], bandwidth=0.1, group_all=False)
